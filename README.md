# nvim-treesitter-queries-nasm

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-nasm/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-nasm/actions/workflows/validate.yml)

Neovim tree-sitter queries for **nasm**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-nasm",
...
- [ ] Changes are scoped to `nasm` — do not include files for other languages
